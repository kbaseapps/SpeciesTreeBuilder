...
function SpeciesTreeBuilder(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.construct_species_tree = function (input, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "SpeciesTreeBuilder.construct_species_tree",
     ...
     this.find_close_genomes = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "SpeciesTreeBuilder.find_close_genomes",
     ...
     this.guess_taxonomy_path = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "SpeciesTreeBuilder.guess_taxonomy_path",
            [params], 1, _callback, _errorCallback);
    };
     ...
     this.build_genome_set_from_tree = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "SpeciesTreeBuilder.build_genome_set_from_tree",
            [params], 1, _callback, _errorCallback);
    };
 
     this.export_tree_newick = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "SpeciesTreeBuilder.export_tree_newick",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "SpeciesTreeBuilder.status",
