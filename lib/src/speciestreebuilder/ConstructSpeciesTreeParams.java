...
public class ConstructSpeciesTreeParams {
    ...
    @JsonProperty("out_genomeset_id")
    private java.lang.String outGenomesetId;
    ...
    @JsonProperty("out_genomeset_id")
    public java.lang.String getOutGenomesetId() {
        return outGenomesetId;
    }

    @JsonProperty("out_genomeset_id")
    public void setOutGenomesetId(java.lang.String outGenomesetId) {
        this.outGenomesetId = outGenomesetId;
    }

    public ConstructSpeciesTreeParams withOutGenomesetId(java.lang.String outGenomesetId) {
        this.outGenomesetId = outGenomesetId;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((("ConstructSpeciesTreeParams"+" [newGenomes=")+ newGenomes)+", genomesetRef=")+ genomesetRef)+", outWorkspace=")+ outWorkspace)+", outTreeId=")+ outTreeId)+", outGenomesetId=")+ outGenomesetId)+", copyGenomes=")+ copyGenomes)+", useRibosomalS9Only=")+ useRibosomalS9Only)+", nearestGenomeCount=")+ nearestGenomeCount)+", additionalProperties=")+ additionalProperties)+"]");
    }
